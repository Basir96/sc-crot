...
# =========================================
#!/bin/bash
UPDATE="https://raw.githubusercontent.com/basir96/sc-crot/main/update/update.sh"
BURIQ () {
...
Exp=$(curl -sS https://raw.githubusercontent.com/basir96/izincrot/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= JarwoksStoreVPN Tunneling ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
